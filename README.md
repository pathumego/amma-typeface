...
A typeface combining the Sinhala and Tamil letters. This project is not about solving the political problems in the country, but to explore the different graphical aspects of cultural boundaries between ethnicities in Sri Lanka and an attempt to dissolve these boundaries in a selected context.
...
#### Repository layout
- `source/` — canonical font source (Amma-Regular.ufo)
- `fonts/` — built font binary
- `docs/` — the project website, published via GitHub Pages
- `archive/` — historical project material: the 2013 BA submission, the 2014 TypoDay paper and presentation, and supporting process documentation (posters, glyph sets, process books)
