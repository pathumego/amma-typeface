    ...
    function widget($args, $instance) {
        ...
        if (stripos($instance['text'], '<form') === false) {
            ...
            if (strpos($options_profile['subscribe'], 'http://') !== false) {
                $form .= '<p><input class="newsletter-submit btn btn-mini " type="image" src="' . $options_profile['subscribe'] . '"/></p>';
            } else {
                $form .= '<p><input class="newsletter-submit btn btn-mini" type="submit" value="' . $options_profile['subscribe'] . '"/></p>';
            }
